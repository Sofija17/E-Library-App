...
import mk.ukim.finki.wp.labgra.model.exceptions.InvalidArgumentsException;
import mk.ukim.finki.wp.labgra.model.exceptions.PasswordsDoNotMatchException;
...
import mk.ukim.finki.wp.labgra.model.exceptions.*;
...
public class UserController {
    ...
    @ApiResponses(
            value = {@ApiResponse(responseCode = "200", description = "User registered successfully"
